...
<AccordionGroup>
  ...
  <Accordion title="Indian acts and legislation" icon="scroll">
...
US case law on Vaquill is powered by [CourtListener](https://www.courtlistener.com/), a service of the [Free Law Project](https://free.law/) - a US 501(c)(3) non-profit. Their open data makes Vaquill's US case-law layer possible. If you build on the Vaquill API, please consider [donating to Free Law Project](https://free.law/donate/) - the open legal-data ecosystem only exists because they keep it alive.

See [Data Sources & Attribution](/data-sources) for the full list of upstream sources.
