...
When you cite a case in a chat response, brief, or memo generated through Vaquill AI, the precedent status is checked automatically and flagged inline if there is a problem.
...
Return a structured memo: **Case Identity, Cited Authorities, Followed By, Distinguished By, Negative Treatment, Good Law Status, Watchlist**. Cite Vaquill AI source IDs for every entry.
</Prompt>
