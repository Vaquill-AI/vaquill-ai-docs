...
<Frame caption="Deep research across statutes, the web, and US case law, with per-source controls">
  <img src="/images/research-1.png" alt="Vaquill deep research: a cited answer with a Statutes, Web, and Keywords sources panel and a source-control popover for Web Search, Matter Documents, US Case Law, and Deep Web Research" style={{ borderRadius: '0.5rem' }} />
</Frame>
