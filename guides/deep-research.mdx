...
<Frame caption="Deep research across statutes, the web, and US case law, with per-source controls">
...
Return a memo-quality output: **Issue, Short Answer, Discussion (with subheadings), Conclusion**. Every factual claim must carry a Vaquill AI source citation.
</Prompt>
