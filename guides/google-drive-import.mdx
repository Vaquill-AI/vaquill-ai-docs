...
Drive Import connects Vaquill AI to your Google Drive so you can pull documents directly into a matter - no download-and-reupload, no version drift between Drive and the matter. Useful when client documents live in shared Drive folders or when you keep your firm's templates and working files in Drive.

<Frame caption="Google Drive connected in Settings, with read-only file access">
  <img src="/images/settings-main.webp" alt="Screenshot of settings showing where integrations are connected" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
- Maintaining one source of truth: documents live in Drive, but are searchable in Vaquill AI
...
<Steps>
  ...
  <Step title="Authorize">
    Authorize Vaquill AI to access your Drive in the Google consent screen.
  </Step>
  <Step title="Pick a scope">
    Choose whether Vaquill AI can see your entire Drive or only a specific folder.
  </Step>
</Steps>
...
Vaquill AI only reads the documents you choose to import - it does not browse your full Drive automatically. When you import a file, the system:
...
<Warning>
  Google's OAuth consent screen lists the scopes Vaquill AI is requesting. If you grant access to your entire Drive, any member who can import in your organization may see file names and metadata for files they pick. Pick a specific folder if you want a tighter blast radius.
</Warning>
