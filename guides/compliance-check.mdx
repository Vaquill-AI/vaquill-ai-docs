...
<Frame caption="Compliance Check results with per-requirement status and remediation steps">
  <img src="/images/tool-compliance.webp" alt="Screenshot of the Compliance tool showing regulation and document category selection" style={{ borderRadius: '0.5rem' }} />
</Frame>
