...
<Frame caption="Compliance sits among the Legal Tools tabs, alongside Contract Review, NDA Triage, and Risk Assessment">
  <img src="/images/compliance-check.png" alt="Compliance Check results: a compliance score with a per-requirement Compliant, Partial, and Non-Compliant breakdown and remediation steps" style={{ borderRadius: '0.5rem' }} />
</Frame>
