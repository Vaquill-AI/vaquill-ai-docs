...
<Frame caption="A focused sub-thread branched from a single passage of an answer">
  <img src="/images/inline-threading.png" alt="A Thread panel branching a focused sub-conversation from a selected sentence in an AI response" style={{ borderRadius: '0.5rem' }} />
</Frame>
