...
<Frame caption="The document set a chronology is built from: the matter's library, scoped by matter and filtered to the files you want">
  <img src="/images/documents.png" alt="Document library showing tagged cards labeled CONTRACT, JUDGMENT, and ARTICLE, with a matter filter and bulk-action controls" style={{ borderRadius: '0.5rem' }} />
</Frame>
