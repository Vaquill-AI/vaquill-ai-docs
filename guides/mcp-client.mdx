...
<CardGroup cols={2}>
  <Card title="CourtListener" icon="scale-balanced" href="/integrations/mcp/courtlistener">
    US federal and state court opinions, dockets, PACER data, and citations. 19 tools. No auth needed.
  </Card>
  <Card title="CanLII" icon="building-columns" href="/integrations/mcp/canlii">
...
- [CanLII MCP](/integrations/mcp/canlii) - Canadian legal data server
