---
title: "MCP Client"
description: "Connect external MCP servers to Vaquill AI and use their tools directly in chat"
icon: "plug"
---

Vaquill AI's MCP Client lets you connect any [Model Context Protocol](https://modelcontextprotocol.io) server - Notion, GitHub, Slack, databases, or your own custom server - so its tools become available inside Vaquill's AI chat alongside the built-in legal tools.

<Info>
  This page covers connecting **external** MCP servers **to** Vaquill AI. If you want to connect **Vaquill AI's tools** to your AI editor (Claude, Cursor, etc.), see [Vaquill MCP](/integrations/mcp/vaquill).
</Info>

<Frame caption="Settings, where MCP servers are connected">
  <img src="/images/mcp-settings.webp" alt="Screenshot of the settings page showing where MCP servers are configured" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<CardGroup cols={2}>
  <Card title="US Statutes" icon="scale-balanced" href="/integrations/mcp/vaquill">
...
- [Vaquill MCP](/integrations/mcp/vaquill) - Connect Vaquill AI's tools to your AI editor
