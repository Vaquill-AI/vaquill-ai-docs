...
Forward incoming vendor compliance questionnaires to the matter address. The inquiry plus any attached drafts become part of the matter, then ask [Chat](/guides/chat) to draft a reply against the ingested email and the vendor record.
