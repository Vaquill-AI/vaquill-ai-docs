...
<Frame caption="Forwarded email and attachments land in the document library">
  <img src="/images/documents.png" alt="Document library showing ingested files as tagged cards with matter filtering, bulk actions, preview, and chat" style={{ borderRadius: '0.5rem' }} />
</Frame>
