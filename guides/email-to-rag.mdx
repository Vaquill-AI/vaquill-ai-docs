...
<Frame caption="Forwarded email and attachments land in the document library">
  <img src="/images/email-ingestion.png" alt="Email Integration: forward emails to a unique matter address to automatically ingest them into the matter" style={{ borderRadius: '0.5rem' }} />
</Frame>
