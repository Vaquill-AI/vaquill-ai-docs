...
<Frame caption="Clients and their matters">
  <img src="/images/matters.png" alt="Clients and Matters view showing matter cards with client names, status, health, and document counts" style={{ borderRadius: '0.5rem' }} />
</Frame>
