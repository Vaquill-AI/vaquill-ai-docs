...
<Frame caption="The document library: tagged cards, matter filter, and the bulk-action bar">
  <img src="/images/documents.png" alt="Vaquill document library showing tagged cards for CONTRACT, JUDGMENT, ARTICLE, and OTHER, a Matter filter, a Cards or list view toggle, and a bulk-action bar with Select All, Chat, Delete, Add Tags, Move to Matter, Move to Folder, Copy to Matter, Preview, and Clear" style={{ borderRadius: '0.5rem' }} />
</Frame>
