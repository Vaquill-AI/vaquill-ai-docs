...
The document library, labelled **Vault** in the sidebar, is where every file you upload lives. Each document is tagged by type, searchable, filterable by matter, and organized into folders. Select one or many and run bulk actions: chat, tag, move, copy, preview, or delete. It is the workspace that ties uploads to the matters they belong to.
