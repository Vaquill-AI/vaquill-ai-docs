...
<Frame caption="Shared matters across a team">
  <img src="/images/matters.png" alt="Clients and Matters view showing the team's matter cards with status, health, document counts, and client names" style={{ borderRadius: '0.5rem' }} />
</Frame>
