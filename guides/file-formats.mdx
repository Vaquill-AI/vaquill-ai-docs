...
description: "Reference list of file formats Vaquill AI can ingest and search, with notes on OCR and special handling"
icon: "file"
---

Vaquill AI ingests over 50 file formats - the ones that show up in real legal practice. Upload them as-is; the system extracts text, runs OCR where needed, and makes the content searchable across your matter.
