...
<Frame caption="Uploaded files organized in the document library">
  <img src="/images/documents.png" alt="Document library showing tagged cards (CONTRACT, JUDGMENT, ARTICLE) with matter filtering, bulk actions, preview, and chat" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
Upload limits vary by plan - see your [dashboard](https://app.vaquill.ai/settings) or the [Subscriptions](/guides/subscriptions) page for current per-plan caps on file size, page count, and batch size. For very large files or batches, contact support to discuss enterprise ingestion options.
