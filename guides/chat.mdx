...
Chat is where most work in Vaquill AI starts. It lives under **Ask Vaquill, AI Chat** in the sidebar. Ask a question in plain language and get an answer with clickable citations back to the source.
...
<CardGroup cols={2}>
  ...
  <Card title="Legal database" icon="landmark">
    Vaquill AI's corpus of statutes, regulations, and case law.
  </Card>
