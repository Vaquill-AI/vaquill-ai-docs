...
individual field does, see [Clause Rules](/guides/playbooks/clause-rules).
...
The **vs. market standard** panel puts your positions side by side with Vaquill AI's built-in baseline for the same clause and your active jurisdiction.
