...
<Tip>
  **Ask why, not just what.** The redline shows what changed. For the reasoning behind a counterparty's edits, attach both versions in [Chat](/guides/chat) and ask, or run [Contract Review](/guides/contract-review) against your [playbook](/guides/playbooks) to see which changes breach your positions.
</Tip>
