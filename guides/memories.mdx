...
<Frame caption="Vaquill keeps context per matter across sessions: each matter card holds its own documents and status">
  <img src="/images/matters.png" alt="Clients and Matters workspace showing matter cards with Open and Active status badges, a health indicator, and a document count on each card" style={{ borderRadius: '0.5rem' }} />
</Frame>
