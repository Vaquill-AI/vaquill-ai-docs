...
<Frame caption="The Matters workspace with per-matter document counts and status">
  <img src="/images/matters.png" alt="Clients and Matters view showing matter cards with Open and Active status, health, document counts, and client names" style={{ borderRadius: '0.5rem' }} />
</Frame>
