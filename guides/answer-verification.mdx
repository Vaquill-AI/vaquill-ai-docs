...
<Frame caption="Every claim traced to its cited source text">
  <img src="/images/research-2.png" alt="A cited statute section, Cal. Civ. Code 1950.7, with its exact cited text expanded and a list of citations behind the answer" style={{ borderRadius: '0.5rem' }} />
</Frame>
