...
<Frame caption="Every claim traced to its cited source text">
  <img src="/images/chat-sources.webp" alt="Screenshot of a verified chat answer showing citations back to sources" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
1. Pull the cited source using Vaquill AI and quote the supporting passage verbatim.
