...
<Frame caption="Every claim traced to its cited source text">
  <img src="/images/answer-verification.png" alt="Response Verification panel showing overall confidence and each claim marked Supported or Refuted against its sources" style={{ borderRadius: '0.5rem' }} />
</Frame>
