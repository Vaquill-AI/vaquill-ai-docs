...
- Seeing how the same clause reads at different levels of aggressiveness

## Searching

Filter by **clause type** and **tone**. Tone matters more than people expect: the same indemnification clause drafted balanced versus aggressive is a genuinely different negotiating position, and picking the wrong one wastes a round.
