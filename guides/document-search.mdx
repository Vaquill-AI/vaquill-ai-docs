...
<Frame caption="A cited answer with the right-hand sources panel and source controls (Web Search, Matter Documents, US Case Law, Deep Web Research)">
  <img src="/images/research-1.png" alt="AI legal research chat showing a cited answer next to a sources panel with Statutes, Web, and Keywords tabs" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<Frame caption="The exact source text behind an answer, with the supporting citations listed">
  <img src="/images/research-2.png" alt="A cited US statute section expanded to show the exact text, with the list of citations that support the answer" style={{ borderRadius: '0.5rem' }} />
</Frame>
