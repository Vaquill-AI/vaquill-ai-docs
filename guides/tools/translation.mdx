...
<Frame caption="Translation is available in the Legal Tools workspace">
  <img src="/images/tools.png" alt="Legal Tools workspace listing Contract Review, NDA Triage, Risk Assessment, Compliance, Responses, OCR, and Feed, with Translation among the available tools" style={{ borderRadius: '0.5rem' }} />
</Frame>
