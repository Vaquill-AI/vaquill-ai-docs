...
<Frame caption="Asking a question on a document, with answer transforms and a sources panel">
  <img src="/images/transform.png" alt="Document Analyst answering a question on a document, with a Transform menu and a sources panel" style={{ borderRadius: '0.5rem' }} />
</Frame>
