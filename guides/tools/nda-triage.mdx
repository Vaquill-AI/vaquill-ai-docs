...
<Frame caption="The NDA Triage tab in the Legal Tools hub">
  <img src="/images/tools.png" alt="Legal Tools workspace with the NDA Triage tab alongside Contract Review, Risk Assessment, Compliance, Responses, OCR, and Feed" style={{ borderRadius: '0.5rem' }} />
</Frame>
