...
<Frame caption="The NDA Triage tab in the Legal Tools hub">
  <img src="/images/nda-triage.png" alt="NDA Triage results with classification and routing, key issues, and a list of problematic provisions" style={{ borderRadius: '0.5rem' }} />
</Frame>
