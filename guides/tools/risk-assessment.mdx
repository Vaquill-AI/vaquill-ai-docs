...
<Frame caption="Risk Assessment in the Legal Tools hub">
  <img src="/images/risk-assessment.png" alt="Risk Assessment results with a 5x5 severity-by-likelihood matrix and an overall risk score" style={{ borderRadius: '0.5rem' }} />
</Frame>
