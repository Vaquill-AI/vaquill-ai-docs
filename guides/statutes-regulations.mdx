...
<Frame caption="A statute section with its full cited text and a list of citations">
  <img src="/images/research-2.png" alt="A state statute section, Cal. Civ. Code 1950.7, with its exact text expanded and a list of citations" style={{ borderRadius: '0.5rem' }} />
</Frame>
