...
<Frame caption="The vendor registry: DPA status, risk tier, and renewal window per vendor">
  <img src="/images/vendors-registry.webp" alt="Screenshot of the Vendors and Sub-processors registry showing eight vendors with type, risk tier, DPA status, and renewal countdown" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<AccordionGroup>
  ...
  <Accordion title="Extract from a DPA" icon="wand-magic-sparkles">
    Point Vaquill AI at an uploaded DPA and it extracts the vendor details from the agreement itself: parties, data categories, processing purpose, region, dates.
...
- Risk tier is your classification, not a Vaquill AI assessment.
