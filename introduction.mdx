...
The statutes API is designed for teams that need legal data as infrastructure. Search the US Code, the CFR, and 49 of 50 state statute codes plus DC and Puerto Rico programmatically (1.5M+ statute sections, refreshed weekly). Indiana statutes are queued.
