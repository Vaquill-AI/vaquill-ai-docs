...
<Frame caption="The Workflows gallery, where you pick a workflow to run">
  <img src="/images/workflows-gallery.webp" alt="Screenshot of the Workflows gallery showing the built-in catalogue you launch a run from" style={{ borderRadius: '0.5rem' }} />
</Frame>
