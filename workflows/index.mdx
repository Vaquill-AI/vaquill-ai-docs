...
<CardGroup cols={2}>
  <Card title="Built-in workflows" icon="grid-2" href="/workflows/built-in">
    25 pre-built pipelines maintained by Vaquill AI. Pick one, upload documents, answer a short form, launch. No configuration.
  </Card>
  <Card title="Workflow Builder" icon="wrench" href="/workflows/builder">
    Chain 25 typed step types into your own pipeline, or describe it in plain English and let Vaquill AI draft the chain for you.
  </Card>
</CardGroup>

<Frame caption="The Workflows gallery: built-in catalogue and your custom workflows">
  <img src="/images/workflows-gallery.webp" alt="Screenshot of the Workflows gallery showing the built-in workflow catalogue grouped by category" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
| | Built-in | Custom |
| --- | --- | --- |
| Who defines the steps | Vaquill AI, in code | You, in the builder |
