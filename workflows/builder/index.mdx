...
description: "Chain typed steps into your own repeatable pipeline, or describe it in plain English and let Vaquill AI draft the chain"
---
...
<CardGroup cols={3}>
  ...
  <Card title="From a prompt" icon="sparkles" href="/workflows/builder/generate-from-prompt">
    Describe what you want in a sentence. Vaquill AI plans the steps, fills the configs, wires the references, and drops you into the builder with an editable draft.
  </Card>
