...
<Frame caption="The Privilege Log Builder launcher: document slots, inputs, and what you get">
  <img src="/images/wf-privilege-log-builder.webp" alt="Screenshot of the Privilege Log Builder launcher showing its document slots and input form" style={{ borderRadius: '0.5rem' }} />
</Frame>
