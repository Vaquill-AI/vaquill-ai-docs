...
- **Replace partner review of citations.** The workflow does not independently verify cases against an external citator at insert time. The appendix is a checklist, not proof.
