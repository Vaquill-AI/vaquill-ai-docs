...
<Frame caption="The Respond to an Eviction launcher: document slots, inputs, and what you get">
  <img src="/images/wf-respond-to-eviction.webp" alt="Screenshot of the Respond to an Eviction launcher showing its document slots and input form" style={{ borderRadius: '0.5rem' }} />
</Frame>
