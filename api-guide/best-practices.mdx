...
Coverage grows weekly, not hourly. Cache the responses of `/statutes/coverage`, `/statutes/states`, and `/statutes/codes` for hours or a day rather than calling them on every request. They still count against your [rate limits](/api-guide/rate-limits).
