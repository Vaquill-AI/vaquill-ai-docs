...
| `EXECUTIVE_ACTION` | Presidential documents (executive orders, proclamations, memos) | federal | 3,620 |
| `FEDERAL_REGISTER` | Federal Register agency rules, final and proposed | federal | 195,895 |
| `AGENCY_GUIDANCE` | Agency guidance (SSA rulings, IRS notices, revenue rulings and procedures) | federal | 2,520 |
