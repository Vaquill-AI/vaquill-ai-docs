...
| Field | Meaning |
|-------|---------|
| `amendmentYears` | Sorted, distinct years credited to the section, including the original enactment. |
| `amendmentsCount` | How many distinct years are in `amendmentYears`. |
...
`amendmentYears` includes the enactment year, so a section enacted in 1991 and never amended reports `[1991]` with `amendmentsCount: 1`.

```json
{
  "actId": "STATE_LA_Crevised-statutes_T39_S54",
  "citation": "La. Rev. Stat. § 39:54",
  "amendmentYears": [1989, 1993, 1997, 2003, 2011, 2013, 2015],
  "amendmentsCount": 7,
...
Ark. Code Ann. 14-284-224
  ...
  -> amendmentYears [1991, 2005, 2007]

Ind. Code 12-15-20-2
  "As added by P.L.2-1992, SEC.9. Amended by P.L.27-1992, SEC.23; ... P.L.205-2013, SEC.203."
  -> amendmentYears [1992, 1997, 1998, 1999, 2000, 2001, 2002, 2003, 2007, 2011, 2013]
```
