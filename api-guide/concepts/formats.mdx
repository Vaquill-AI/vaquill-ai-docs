...
```bash cURL
curl "https://api.vaquill.ai/api/v1/statutes/section/USC_T42_C21_S1983/body?structured=true" \
...
data = requests.get(
    "https://api.vaquill.ai/api/v1/statutes/section/USC_T42_C21_S1983/body",
