...
<AccordionGroup>
  <Accordion title="Scope retrieval to the right corpusType" icon="filter">
    ...
    If you are unsure which corpora a jurisdiction has, call `GET /statutes/coverage` and read the `corpora` keys before you search. See [Coverage](/api-guide/coverage).
  </Accordion>
