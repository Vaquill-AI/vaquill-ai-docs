...
<AccordionGroup>
  ...
  <Accordion title="Watch what retrieval costs you" icon="coins">
    A grounded turn is one search plus one body per section you cite, so cost scales with how many sections you cite rather than how many you retrieve. Cache on `actId`, which is a stable handle for a section, and read `creditsConsumed` on every response rather than computing cost from your page size.
  </Accordion>
</AccordionGroup>
