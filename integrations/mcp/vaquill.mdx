...
The server exposes statute tools across three categories. Credit costs match the [pricing schedule](/api-reference/pricing/get-api-credit-pricing) and can be checked live with `get_pricing`.
