...
description: "Cross-jurisdiction legal research MCP for Claude, Cursor, VS Code, and Windsurf. USC + CFR + 50-state law + CourtListener case law, plus 20M+ Indian judgments and 23K+ Indian acts."
icon: "scale-balanced"
keywords: ["vaquill mcp", "legal mcp server", "claude legal mcp", "us law mcp", "usc mcp", "cfr mcp", "courtlistener mcp", "cursor legal research", "vs code legal mcp", "indian law mcp"]
---

The Vaquill MCP server gives any [Model Context Protocol](https://modelcontextprotocol.io) client - Claude.ai, Claude Desktop, Claude Code, Cursor, VS Code, Windsurf - direct access to the Vaquill legal research API. It covers **US federal and 50-state law** (USC, CFR, state legislation, and CourtListener case law) and also includes 20M+ Indian Supreme Court and High Court judgments plus 23K+ Indian acts. Source: [github.com/Vaquill-AI/vaquill-mcp](https://github.com/Vaquill-AI/vaquill-mcp).
...
>
> *"Look up Maneka Gandhi v. Union of India and show treatment stats."*
>
> *"Show the citation network around ADM Jabalpur v. Shivkant Shukla."*
...
1. Call `resolve_citation` (or the US-equivalent lookup) on `457 U.S. 800` to confirm the canonical case record.
2. Call `lookup_case` (or `get_opinion` if using CourtListener) to pull the full opinion plus treatment stats.
