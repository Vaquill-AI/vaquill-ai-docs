...
See the full schema in the [Statutes Search API reference](/api-reference/us-statutes/search-us-statutes-constitutions-court-rules-and-executive-actions).
...
<CardGroup cols={2}>
  ...
  <Card title="Statutes Search API" icon="message" href="/api-reference/us-statutes/search-us-statutes-constitutions-court-rules-and-executive-actions">
