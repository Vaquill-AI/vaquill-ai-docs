...
<CardGroup cols={2}>
  <Card title="MCP Servers" icon="plug" href="/integrations/mcp">
    Plug Vaquill's full US legal corpus into Claude, Cursor, VS Code, or any MCP client.
  </Card>
...
| Connect a third-party MCP for direct CourtListener API access | [CourtListener MCP](/integrations/mcp/courtlistener) |
