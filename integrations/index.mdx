...
Put Vaquill AI wherever your team already works - Claude, Slack, a marketing site, a Google Sheet. Every integration is open-source, self-hostable, and calls the same [Vaquill statutes API](/api-reference/statutes/search-us-statutes) under the hood.
