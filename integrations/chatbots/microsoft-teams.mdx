...
<Steps>
  ...
  <Step title="Generate your Vaquill API key">
    Sign in to the [Vaquill AI dashboard](https://app.vaquill.ai/settings) and generate a key. Save it as `VAQUILL_API_KEY`.
  </Step>
</Steps>
